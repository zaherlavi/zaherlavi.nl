...
const projects: Project[] = [
  {
    ...
    description:
      "Developing software for school's examination hall using networking protocols.",
  },
  {
    title: "Object-Oriented Programming Projects",
    period: "Aug 2023 - Current",
    description:
      "Developing games like Snake and Tetris using Scala with emphasis on immutability.",
  },
  {
    title: "IJVM Interpreter",
    period: "Jun 2023",
    description:
      "Created a Java assembly interpreter using C, working with byte code implementation.",
  },
  {
    title: "Chat Application",
    period: "May 2023 - Jun 2023",
    description:
      "Built a chat application using Python with TCP and UDP protocols.",
  },
];
      ...
      >
        <div className="max-w-4xl mx-auto">
          <p className="text-lg leading-relaxed mb-12">
            Enthusiastic computer science student with a strong passion for
            coding and problem-solving. Eager to pursue a career as a developer,
            utilizing my foundational knowledge in programming, algorithms, and
            data structures.
          </p>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-purple-200 mb-2">
                    Vrije Universiteit of Amsterdam (2022 - Present)
                  </p>
                  <p>
                    Supporting the exam hall and assisting students with
                    IT-related issues during exams.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-purple-200 mb-2">
                    Barg Print (2019 - 2020)
                  </p>
                  <p>
                    Managing client portfolio, building branding, and designing
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-purple-200">
                    Vrije Universiteit Amsterdam (2022 - Present)
                  </p>
                </div>
                <div>
                  <h4 className="text-xl font-semibold">
                  ...
                  <p className="text-purple-200">
                    Payame Noor University (2015 - 2019)
                  </p>
                </div>
              </div>
            </div>
